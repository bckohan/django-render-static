...
class TestContextResolution(BaseTestCase):
    ...
    def test_pickle_context_resource(self):
        self.assertEqual(
            resolve_context(
                resource("render_static.tests.resources", "context.pickle")
            ),
            {"context": "pickle"},
        )
    ...
    def test_python_context_embedded_import(self):
        ...
        self.assertEqual(
            resolve_context(
                "render_static.tests.resources.context_embedded.get_context"
            ),
    ...
    def test_bad_contexts(self):
        self.assertRaises(
            ...
            lambda: resolve_context(
                "render_static.tests.resources.context_embedded.not_a_dict"
            ),
        )
        self.assertRaises(
            InvalidContext,
            lambda: resolve_context(
                resource("render_static.tests.resources", "bad.pickle")
            ),
        )
        self.assertRaises(
            InvalidContext,
            lambda: resolve_context(
                resource("render_static.tests.resources", "not_a_dict.pickle")
            ),
        )
        self.assertRaises(
            InvalidContext,
            lambda: resolve_context(
                resource("render_static.tests.resources", "bad_code.py")
            ),
        )
        self.assertRaises(
            InvalidContext,
