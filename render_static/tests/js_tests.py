    ...
    STATIC_TEMPLATES={
        ...
        "templates": {
            ...
            "defines2.js": {
                ...
                "context": {"modules": [defines, "render_static.tests.defines2"]},
            },
            "defines_error.js": {
            ...
            "empty_defines.js": {
                ...
                "context": {"classes": ["render_static.tests.empty_defines"]},
            },
        },
    }
)
                    ...
                    "OPTIONS": {
                        ...
                        "loaders": [
                            (
                                "render_static.loaders.StaticLocMemLoader",
                                {
                                    "defines1.js": '{% defines_to_js defines="render_static.tests.defines.ExtendedDefines" indent="  " %}'
                                    "\nconsole.log(JSON.stringify(defines));"
                                },
                            )
                        ],
                    ...
                    "OPTIONS": {
                        ...
                        "loaders": [
                            (
                                "render_static.loaders.StaticLocMemLoader",
                                {
                                    "defines2.js": '{% defines_to_js defines="render_static.tests.defines2" %}'
                                    "\nconsole.log(JSON.stringify(defines));",
                                },
                            )
                        ],
                    ...
                    "OPTIONS": {
                        "loaders": [
                            (
                                "render_static.loaders.StaticLocMemLoader",
                                {
                                    "urls.js": '{% urls_to_js transpiler="render_static.tests.js_tests.BadVisitor" %};'
                                },
                            )
                        ],
                        "builtins": ["render_static.templatetags.render_static"],
    ...
    STATIC_TEMPLATES={
        ...
        "templates": [
            ...
            (
                "enum_app/test.js",
                {
                    "context": {"enums": "render_static.tests.enum_app.defines.Def"},
                    ...
                    "OPTIONS": {
                        "loaders": [
                            (
                                "render_static.loaders.StaticLocMemLoader",
                                {
                                    "enum_app/test.js": "{% enums_to_js enums='render_static.tests.enum_app.models.EnumTester.Nope' %}"
                                },
                            ),
                            (
                                "render_static.loaders.StaticLocMemLoader",
                            ...
                            (
                                "render_static.loaders.StaticLocMemLoader",
                                {
                                    "enum_app/test4.js": "{% enums_to_js enums='render_static.tests.enum_app.models.DNE' %}"
                                },
                            ),
                        ],
                        "builtins": ["render_static.templatetags.render_static"],
