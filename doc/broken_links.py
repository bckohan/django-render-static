"""
This script processes the output of sphinxbuild -d linkcheck to find broken links. It
will pretty print broken links to stderr and return a non-zero exit code if any broken
links are found.
"""
